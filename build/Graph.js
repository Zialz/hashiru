...
export default function Graph(props) {
  ...
  return (
    <div className="container ">
      ...
      <div class="row">
        <div class="col">
          <button onClick={() => fitBounds()} className="btn btn-outline-danger m-1">Recentrer le parcours</button>
          <br></br>
          <p>Longueur du parcours : 11km</p>
          <p>Durée du parcours : 23min</p>
        ...
        <div class="col">
          {graph &&
            <div>
              <button onClick={() => { setGraph(!graph) }} className="btn btn-outline-danger m-1">Analyser tout le parcours</button>
          ...
          {!graph &&
            <div>
              <button onClick={() => { setGraph(!graph) }} className="btn btn-outline-danger m-1">Analyser une portion du parcours</button>
